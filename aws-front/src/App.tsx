...
export function App() {
  ...
  async function criarMoeda() {
    ...
    try {
      await axios.post("https://epb5oax00l.execute-api.us-east-1.amazonaws.com/prod/moedas", { nome: nomeCriar.trim(), valor: valorNum });
      setOpenCriar(false);
      setNomeCriar("");
      setValorCriar("");
      fetchMoedas();
  ...
  async function editarMoeda() {
    ...
    try {
      await axios.put(`https://epb5oax00l.execute-api.us-east-1.amazonaws.com/prod/moedas/${nomeEditar.trim()}`, { valor: valorNum });
      setOpenEditar(false);
      setNomeEditar("");
      setValorEditar("");
      fetchMoedas();
  ...
  async function deletarMoeda() {
    ...
    try {
      await axios.delete(`https://epb5oax00l.execute-api.us-east-1.amazonaws.com/prod/moedas/${nomeDeletar.trim()}`);
